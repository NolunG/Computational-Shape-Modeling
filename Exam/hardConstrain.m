...
%  function adds add hard constraints by rewriting linear system 
%   consi is row indices of values to constrain
%   consv is constrained values
%   rewrite_system = is if variables in consi should be removed from system 
